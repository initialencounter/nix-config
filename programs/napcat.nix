{ config, pkgs, lib, ... }: let
  sources = {
    ...
    napcat_version = "v4.1.15";
    napcat_url = "https://github.com/NapNeko/NapCatQQ/releases/download/v4.1.15/NapCat.Shell.zip";
    napcat_hash = "sha256-jTTr5lWAmI1FB6Bjs9+h/O0rAWsmvdnwSNkpkgY71Ao=";
